...
def start_cloudflared(app, port, metrics_port):
    ...
    app.cloudflared_address = cloudflared_address
    app.metrics_address = f"http://127.0.0.1:{metrics_port}/metrics"
...
def run_with_cloudflared(app):
    ...
    def new_run(*args, **kwargs):
        ...
        thread = Timer(1, start_cloudflared, args=(app, port, metrics_port,))
